...
class VoteNet(SingleStage3DDetector):
    ...
    def loss(self, batch_inputs_dict: Dict[str, Union[List, Tensor]],
        ...
        """
        if getattr(self.backbone, 'runtime_cfg', None) is not None:
            self.backbone.runtime_cfg['batch_data_samples'] = batch_data_samples
            self.backbone.runtime_cfg['predict'] = False
    ...
    def predict(self, batch_inputs_dict: Dict[str, Optional[Tensor]],
        ...
        if getattr(self.backbone, 'runtime_cfg', None) is not None:
            self.backbone.runtime_cfg['batch_data_samples'] = batch_data_samples
            self.backbone.runtime_cfg['predict'] = True
